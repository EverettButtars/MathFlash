...
class Division2 : AppCompatActivity(), View.OnClickListener {
    ...
    var score = 0
    var totalQuestion:Int = FractionQuestionsAnswers.question.size
    ...
    override fun onClick( view: View) {
        ...
        if (clickedButton.id == R.id.submit){
            if ( selectedAnswer == FractionQuestionsAnswers.correctAnswers[currentQuestionIndex]){
                score ++
            }
    ...
    private fun loadNewQuestion() {
        ...
        questionTextView.text = FractionQuestionsAnswers.question[currentQuestionIndex]
        first.text = FractionQuestionsAnswers.choices[currentQuestionIndex][0]
        second.text = FractionQuestionsAnswers.choices[currentQuestionIndex][1]
        third.text = FractionQuestionsAnswers.choices[currentQuestionIndex][2]
        fourth.text = FractionQuestionsAnswers.choices[currentQuestionIndex][3]
    }
