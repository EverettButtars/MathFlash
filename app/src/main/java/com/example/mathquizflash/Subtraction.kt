...
class Subtraction : AppCompatActivity(),View.OnClickListener {
    ...
    var score = 0
    var totalQuestion:Int = SubtractionQuestionsAnswers.question.size
...
override fun onClick( view: View) {
    ...
    if (clickedButton.id == R.id.submit){
        if ( selectedAnswer == SubtractionQuestionsAnswers.correctAnswers[currentQuestionIndex]){
            score ++
        }
...
private fun loadNewQuestion() {
    ...
    questionTextView.text = SubtractionQuestionsAnswers.question[currentQuestionIndex]
    first.text = SubtractionQuestionsAnswers.choices[currentQuestionIndex][0]
    second.text = SubtractionQuestionsAnswers.choices[currentQuestionIndex][1]
    third.text = SubtractionQuestionsAnswers.choices[currentQuestionIndex][2]
    fourth.text = SubtractionQuestionsAnswers.choices[currentQuestionIndex][3]
}
